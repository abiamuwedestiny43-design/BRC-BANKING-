...
const LoansPage: React.FC = () => {
  return (
    <div className="animate-fade-in pt-20">
      ...
      <section
        className="relative py-32 bg-cover bg-center text-white animate-fade-in-up animation-delay-50"
        style={{
          backgroundImage:
      ...
      {/* Loan Types */}
      <section className="py-20 bg-gray-50 animate-fade-in-up animation-delay-100">
