        ...
        <div className="lg:col-span-2 space-y-8">
          <Card className="bg-white/[0.03] border-white/5 rounded-[3rem] overflow-hidden">
            <CardHeader className="p-8 border-b border-white/5 bg-white/[0.01]">
              ...
              <CardDescription className="text-slate-500 font-medium">Control the global flow of assets across the BRC BANKING framework.</CardDescription>
            </CardHeader>
            <CardContent className="p-8 space-y-12">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 p-6 rounded-[2rem] bg-white/5 border border-white/5 group hover:bg-blue-500/5 hover:border-blue-500/20 transition-all">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-slate-500 max-w-sm">Restrict migrations within the internal BRC BANKING BANK node network.</p>
                </div>
                <div className="flex items-center gap-6">
                  <Switch
