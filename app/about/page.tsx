      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed mb-12 animate-slide-up">
            For over five decades, NOVA BANK has been more than just a financial
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-slate-400 leading-relaxed text-lg">
                <p>
                  At NOVA BANK, we believe that finance is not only about numbers — it’s
      ...
      <section className="py-32 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-6xl font-black tracking-tight">The NOVA Standard</h2>
          </div>
      ...
      <section className="py-32">
        <div className="max-w-5xl mx-auto px-4">
          <div className="relative rounded-[3rem] bg-gradient-to-br from-[#003d24] to-[#001c10] p-12 md:p-20 text-center space-y-8 overflow-hidden border border-white/10 shadow-3xl">
            <h2 className="text-4xl md:text-5xl font-black tracking-tighter leading-tight relative z-10">Start Your Legacy <br /> with NOVA BANK</h2>
