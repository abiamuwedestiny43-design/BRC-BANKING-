const fs = require('fs');
let content = fs.readFileSync('components/home/Home.tsx', 'utf8');
...
// Special cases
content = content.replaceAll('bg-white text-[#001c10]', 'bg-black text-white');
content = content.replaceAll('bg-white text-white', 'bg-black text-white'); // because of earlier text-white rep

fs.writeFileSync('components/home/Home.tsx', content);
