      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl leading-relaxed">
            For over five decades, BRC BANKING has been more than just a financial
            ...
            <br />
            <br />
            At BRC BANKING, we believe that finance is not only about numbers — it’s
            ...
            trust, innovation, and sustainability, BRC BANKING is committed to
